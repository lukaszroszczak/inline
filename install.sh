...
echo ""
echo "2. Open a terminal and activate the virtual environment:"
echo "   cd $(pwd)"
echo "   source ${VENV_DIR}/bin/activate"
echo ""
echo "3. Configure the Zigbee buttons:"
...
echo "   # The user running this command must be the one logged into the desktop."
echo "   # You may be prompted for the user's password for 'sudo'."
